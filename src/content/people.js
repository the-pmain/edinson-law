export const people = [
  ...
  },
  {
    ...
    initials: "CR",
    role: "Restraint & Freezing Orders Solicitor",
    firm: "Edison Law",
    ...
    bio: [
      ...
      "Caroline gives clear advice on urgency, evidential gaps and the practical consequences of seeking an order. Interim relief remains discretionary, and preservation of an asset does not guarantee its eventual recovery.",
    ],
    areas: [
      "Freezing and proprietary injunctions",
      "Bank and third-party disclosure applications",
      "Evidence for urgent interim relief",
      "Undertakings, return dates and variation",
    ],
  },
  {
    slug: "marcus-quinn",
